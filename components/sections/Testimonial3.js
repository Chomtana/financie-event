                                    ...
                                    <Swiper {...swiperOptions} className="swiper-wrapper">
                                        <SwiperSlide>
                                            <div className="box-testimonial">
                                                <img className="quote" src="/assets/images/testimonial/left-quote1.png" alt="AI-Mint" />
                                                <p className="text">Keniam, quis nostrud exerci ut aliquip ex ea com modo cons equ
                                                    ...
                                                    proid</p>
                                                <div className="info">
                                                    <img src="/assets/images/testimonial/avt-02.png" alt="AI-Mint" />
                                                    <div>
                                                        <h6>Paul Harrison </h6>
                                        ...
                                        <SwiperSlide>
                                            <div className="box-testimonial">
                                                ...
                                                <p className="text">Keniam, quis nostrud exerci ut aliquip ex ea com modo cons equ
                                                    ...
                                                    proid</p>
                                                <div className="info">
                                                    <img src="/assets/images/testimonial/avt-03.png" alt="AI-Mint" />
                                                    <div>
                                                        <h6>Paul Harrison </h6>
                                                        <p className="fs-16">Founder &amp; CEO</p>
                                                    </div>
                                        ...
                                        <SwiperSlide>
                                            <div className="box-testimonial">
                                                ...
                                                <p className="text">Keniam, quis nostrud exerci ut aliquip ex ea com modo cons equ
                                                    ...
                                                    proid</p>
                                                <div className="info">
                                                    <img src="/assets/images/testimonial/avt-04.png" alt="AI-Mint" />
                                                    <div>
                                                        <h6>Paul Harrison </h6>
                                                        <p className="fs-16">Founder &amp; CEO</p>
                                                    </div>
