                            ...
                            <div className="row">
                                <div className="col-12">
                                    <div className="blog-img">
                                        <img src="/assets/images/events/ivs-demo.avif" alt="AI-Mint" />
                                    </div>
                                </div>
                            </div>
                            <div className="row">
                                    ...
                                    <div className="blog-body">
                                        <div className="blog-content">
                                            <ul className="meta">
                                                ...
                                                <li><Link href="#"><i className="fa fa-clock" />July 05, 2024</Link></li>
                                            </ul>
                                            <h3 className="title">
                                                IVS Demo Day
                                            </h3>
                                            <p className="fs-18">​In the 3 year of IVS Crypto, the web3 version of the launchpad "IVS Crypto THE DEMODAY" is finally being held.</p>
                                            <p className="fs-18 mt-28"><b>Isn't it time to show the world how serious web3 builders are?</b></p>
                                            <p className="fs-18 mt-28">IVS Crypto THE DEMODAY is a demo pitch event for web3 builders. Demonstrate the products you have built so far in front of 15,000 innovators, including global projects, entrepreneurs, investors, managers, and large companies, who gather at IVS/IVS Crypto.</p>
                                            <p className="fs-18 mt-28">We are looking for builders and products that surpass the original launchpad. Since THE DEMODAY is not a hackathon, you can also submit products that have already been launched. Any builder who wants to demo in the largest hall venue in IVS/IVS Crypto and connect with an audience of 15,000 people can enter.</p>
                                            <p className="fs-18 mt-28">You will be the one to build the next mainstream.</p>
